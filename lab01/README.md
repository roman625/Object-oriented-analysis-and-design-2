...
|----------|----------|----------------|
| **Вес груза** | Максимальная масса в килограммах | 5 кг (дрон), 50 кг (велосипед), 1500 кг (авто) |
| **Расстояние** | Дистанция доставки в километрах | 10 км, 20 км, 500 км |
| **Пассажиры** | Количество людей для перевозки | 0 (груз), 1, 5 |
...
3. Нажмите `F5` или кнопку ▶️ **Start**
...
| Критерий | Factory Method (ваш код) | Abstract Factory (пример) |
|----------|-------------------------|--------------------------|
| **Назначение** | Создание одного продукта через наследование | Создание семейства связанных продуктов |
| **Гибкость** | Легко добавить новый тип продукта | Легко добавить новое семейство (регион) |
| **Сложность** | Проще, меньше классов | Сложнее, больше интерфейсов |
| **Наш случай** |  Подходит: один продукт «Транспорт» с вариантами |  Избыточен: нет семейств продуктов |
